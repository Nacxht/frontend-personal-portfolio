		...
		<section id="educations">
			<div class="step">
				<Steps title={"School at SMK Krian 1"} date={"2019 - 2023"}>
					...
					inventore vel? Nobis, non quasi. Aperiam et dignissimos debitis deserunt accusantium sint
					beatae hic labore rerum porro doloribus non, unde ad similique, odio ipsam. Perspiciatis
					itaque aspernatur illum quae? Qui quae incidunt repudiandae minus perferendis
